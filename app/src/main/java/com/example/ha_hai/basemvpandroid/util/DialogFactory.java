package com.example.ha_hai.basemvpandroid.util;
...
public final class DialogFactory {
    ...
    public static Dialog createGenericErrorDialog(Context context, String message) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context, R.style.AppTheme).setTitle(context.getString(R.string.generic_error_title)).setMessage(message).setNeutralButton(R.string.dialog_action_ok, null);
        return alertDialog.create();
    }
    ...
    public static Snackbar showErrorSnackBar(Context mContext, View rootView, Throwable throwable) {
        ...
        tv.setTextColor(ContextCompat.getColor(mContext, R.color.abc_btn_colored_text_material));
        return snack_error;
    }
